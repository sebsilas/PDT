...
#' @param import_musicassessr_js_scripts
#'
#' @return
#' @export
#'
...
PDT <- function(num_items = 10L, with_final_page = TRUE,
                headphones_page = TRUE, import_musicassessr_js_scripts = TRUE) {

  timeline <- psychTestR::new_timeline(psychTestR::join(

    psychTestR::one_button_page(shiny::tags$div(
                                if(import_musicassessr_js_scripts) musicassessr::musicassessr_js_scripts(),
